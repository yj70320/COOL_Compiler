...
{
       0,   119,   119,   123,   125,   130,   133,   140,   141,   146,
     148,   150,   156,   157,   162,   174,   175,   176,   177,   178,
     179,   180,   181
};
#endif
...
#line 177 "cool.y"
                      { (yyval.expression) = object_id((yyvsp[0].symbol)); }
